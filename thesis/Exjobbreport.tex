...
figure~\ref{fig:res_FlashIntC}. Samples annealed with an intensity less than
...
figure~\ref{fig:res_FlashIntC}a and b the PUND characteristics show
...
figure~\ref{fig:res_FlashIntC}c show an increased endurance for the flash
