...
samples, as described in Chapter~\ref{ch:char} the remnant polarization ($P_r$), coercive
field ($E_c$), endurance and defect density ($D_d$) were measured and tabulated in table~\ref{tab:RTPref}.
