...
includes pyrometer measurements of the back temperature during annealing (green). The
measured temperatures are in reasonable agreement with the simulations proving
the accuracy of our model. The discrepancies are attributed to the preheating
elements being in close proximity to the pyrometer focus area (See figure~\ref{fig:fab_FLAsetup}).

\begin{figure}[htbp]
    \centering
    \includegraphics[width=.45\linewidth]{fig/COMSOLFlashInt.png}
...
These simulations give

\begin{equation}
    T_{peak} = 495.5 + 16.3 \cdot E_{pulse}
\end{equation}
...
\begin{figure}[htbp]
    \centering
    (a)\includegraphics[width=.45\textwidth]{example-image}
    (b)\includegraphics[width=.45\textwidth]{example-image}
    (c)\includegraphics[width=.45\textwidth]{example-image}
    (d)\includegraphics[width=.45\textwidth]{example-image}
